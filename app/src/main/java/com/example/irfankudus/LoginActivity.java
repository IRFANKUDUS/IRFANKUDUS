package com.example.irfankudus;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        btnLogin.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                editor.apply();
                if (txtusername.getText().toString().equalsIgnoreCase("irfan") && txtpassword.getText().toString().equals("irfan123")){
                    Intent in = new Intent(LoginActivity.this,MainMenuActivity.class);
                    Toast.makeText(LoginActivity.this, "Welcome irfan kudus", Toast.LENGTH_SHORT).show();
                    startActivity(in);
                    finish();
        ...
        tvforgot.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Toast.makeText(LoginActivity.this, "Default username & password = irfan", Toast.LENGTH_SHORT).show();
            }
        });
